 ...
 * @author HP
 */
public class searchAppointmentRes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement pstmt = conn.prepareStatement("SELECT email, passwords FROM users WHERE email = ?");
...
"            width: 30%; height: 10%; text-align:center;'>");
            ...
            while (rs.next()) {
                ...
                userDetailsHTML.append("<td>").append(rs.getString("passwords")).append("</td>");
                userDetailsHTML.append("<td><a style='color: white;\n" +
                "  background-color: red;\n" +
                "  padding: 5px 10px;\n" +
                "  border-radius: 3px;\n" +
                "  text-decoration: none;' href='DeleteUserServlet?email=" + rs.getString("email") + "''>Delete</a></td>");
            ...
            "font-size: 16px;\n" +
            "border-radius: 10px;\n" +
            "cursor: pointer;' href=\"receptionist.jsp\">Back To View All</a>");
